...
import {FlatList,SafeAreaView,StyleSheet, Text,TextInput, TouchableOpacity,View,Alert,} from'react-native';
    ...
    try {
      ...
      if (storedData) {
        ...
        if (Array.isArray(parsedData)) {
          setTodos(parsedData); // Eğer array ise state'e set edin
        } else {
          setTodos([]); // Eğer array değilse boş array olarak başlat
        }
      }
    } catch (error) {
      console.log(error);
